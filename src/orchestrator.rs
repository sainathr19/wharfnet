...
/// The chains wharfnet boots. M1 ships a single EVM chain; M2 appends the
/// second EVM plus Solana and Starknet engines here.
fn engines() -> Vec<Box<dyn Engine>> {
    vec![Box::new(EvmEngine::anvil("anvil-1", 8545, 31337))]
}
...
mod tests {
    ...
    #[test]
    fn render_compose_has_header_and_service() {
